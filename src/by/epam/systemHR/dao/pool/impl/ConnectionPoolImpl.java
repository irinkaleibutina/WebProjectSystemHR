package by.epam.systemHR.dao.pool.impl;

import by.epam.systemHR.dao.pool.DBParameter;
import by.epam.systemHR.dao.pool.DBResourceManager;
...
/**
 * #ConnectionPool interface implementation for custom simple Connection pool
 */
public class ConnectionPoolImpl implements ConnectionPool {
	 ...
	 *             appears when can't get connection or initialize database
	 *             driver
	 */
	@Override
	public void init() throws ConnectionPoolException {
		...
		try {
			...
			availableConnectionQueue = new ArrayBlockingQueue<>(poolSize);
	...
	/**
	 * Proxy for Connection interface
	 */
